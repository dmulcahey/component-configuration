...
public class ClasspathResourceInjectionAnnotationBeanPostProcessor  implements MergedBeanDefinitionPostProcessor, PriorityOrdered {
	...
	public ClasspathResourceInjectionAnnotationBeanPostProcessor() {
		this.configurationResourceAnnotationType = com.bms.componentconfiguration.spring.ClasspathResource.class;
	}
	...
	private ClasspathResource getConfigurationResource(ConfigurationElement element) {
		com.bms.componentconfiguration.spring.ClasspathResource annotation = (com.bms.componentconfiguration.spring.ClasspathResource) element.getField().getAnnotation(this.configurationResourceAnnotationType);
